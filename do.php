      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel">
          ...
          <?php
            ...
            $conexao = mysqli_connect("localhost", "root", "", "crafter"); // Modify database credentials as needed
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '
                        <a href="Jogos/' . $row["Title"] . '.zip" target="_blank"><span style="color: rgb(0, 0, 0);">
                          <div class="item" styles = "height:300px;">
                            <div class="box">
                                <div class="img-box">
                                    <img src="images/' . $row["Title"] . '.png" alt="">
                                </div>
